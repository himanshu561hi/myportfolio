        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
          {profiles.map((profile, index) => (
            <motion.div
              ...
              className="flex flex-col h-full p-8 bg-white/60 backdrop-blur-[20px] border border-white/80 rounded-[28px] shadow-[0_8px_32px_rgba(0,0,0,0.04)] hover:shadow-[0_0_30px_rgba(37,99,235,0.12)] hover:-translate-y-2 hover:border-blue-300 transition-all duration-300 group"
            >
