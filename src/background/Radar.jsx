...
export default function Radar({
  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      ...
      resizeTimeout = setTimeout(resize, 150); // Throttled window resizing
    };
    ...
    function update(time) {
      ...
      // Dynamic rendering pause if container is not in view or tab is hidden
  ...
  return (
    <>
      <div ref={containerRef} className="radar-container" style={{ width: '100%', height: '100%', position: 'absolute', top: 0, left: 0, pointerEvents: 'none' }} />
      <style>{`
